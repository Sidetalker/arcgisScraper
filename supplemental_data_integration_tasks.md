...
- [x] **Extend CLI enrichment**: Update `scrape_arcgis.py` (and related helpers) to fetch new layers during a single run, join zoning/land-use attributes, and propagate them into CSV/Excel/JSON outputs. Refer to `docs/phase1_compliance_overlays.md` for usage examples.
